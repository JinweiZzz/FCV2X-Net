...
class Env:
    ...
    def get_state(self, road, destination):
        ...
        edge_attr = np.concatenate([self.angle_triplet_matrix[:, :, [self.road_id2idxs[destination]]]/180, np.expand_dims(self.distance_matrix, axis=2)/1000], axis=2)
        return state, edge_attr
